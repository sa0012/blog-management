  ...
  methods: {
    ...
    upqiniu(req) {
      ...
      const keyname =
        ...
        filetype;
      // 从后端获取上传凭证token
      $.get("/upload/getUploadToken").then(res => {
        ...
        // 获取到凭证之后再将文件上传到七牛云空间
        console.log('/upload/getImgUpload', 'formdata')
        window.axios.post('/upload/getUploadImg', formdata, config)
